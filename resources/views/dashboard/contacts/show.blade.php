...
@section('content')
    <center>
        <div class="card-body shadow mb-4 col-9">
            <a class="btn btn-primary" href="{{ route('admin.contacts.index', ['page' => request()->page]) }}">Back To
                Contacts</a>
            <br><br>
