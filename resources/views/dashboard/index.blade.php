...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card-body shadow col-6">
                <h4>{{ $news_by_category_chart->options['chart_title'] }}</h4>
                {!! $news_by_category_chart->renderHtml() !!}

            </div>
            <div class="card-body shadow col-6">
                <h4> {{ $authors_chart->options['chart_title'] }} </h4>
                {!! $authors_chart->renderHtml() !!}
...
{!! $news_by_category_chart->renderJs() !!}
{!! $authors_chart->renderJs() !!}
@endpush
