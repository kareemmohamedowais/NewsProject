        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="form-group">
                <input type="text" value="{{ old('name') }}" name="name" placeholder="Enter site Name" class="form-control">
                <br>
                <input type="text" value="{{ old('url') }}" name="url" placeholder="Enter site Url" class="form-control">
                <br>
