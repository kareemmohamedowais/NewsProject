        ...
        <form action="{{ route('admin.admins.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                           Enter Name: <input type="text" value="{{ old('name') }}" name="name" placeholder="Enter Admin name" class="form-control">
                            @error('name')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Username<input type="text" value="{{ old('username') }}" name="username" placeholder="Enter Admin Username" class="form-control">
                            @error('username')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Email:<input type="email" value="{{ old('email') }}" name="email" placeholder="Enter Admin Email" class="form-control">
                            @error('email')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
