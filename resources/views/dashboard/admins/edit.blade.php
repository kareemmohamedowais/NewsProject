        ...
        <form action="{{ route('admin.admins.update' , $admin->id) }}" method="post">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                           Enter Name: <input value="{{ $admin->name }}" type="text" name="name" placeholder="Enter Admin name" class="form-control">
                            @error('name')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Username<input value="{{ $admin->username }}" type="text" name="username" placeholder="Enter Admin Username" class="form-control">
                            @error('username')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            Enter Email:<input value="{{ $admin->email }}" type="email" name="email" placeholder="Enter Admin Email" class="form-control">
                            @error('email')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
